...
const ProductSuggest = ({ productDtl, handleClear }: ProductSuggestProps ) => {
	...
	return (
		<div className='group flex flex-row items-center justify-between gap-[0.5rem] w-[634px] bg-[#d1d5db] rounded-[60px] py-0 px-[0.5rem] mb-0 h-[75px] border-black border-[1px] hover:bg-[#daddeb] hover:border-gray-700 hover:cursor-pointer' onClick={(e: React.MouseEvent<HTMLElement>) => handleClick(e, `/product/${productDtl.name}`)}>
