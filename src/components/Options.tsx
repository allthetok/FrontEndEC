	...
	return (
		<>
			...
			<div className='flex flex-col gap-6 items-center'>
				...
				<ToastAdd open={open} setOpen={setOpen} router={router} name={productDtl.name} colorSelected={colorQuery as string} sizeOption={sizeOption} colorImage={productDtl.colors.filter((indColor: Colors) => indColor.color === colorQuery)[0].images[0]} />
